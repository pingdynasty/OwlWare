...
#define MIDI_STREAMING_INTERFACE_DESC_SIZE            0x07
#define MIDI_INPUT_JACK_DESC_SIZE                     0x06
#define MIDI_OUTPUT_JACK_DESC_SIZE					  0x09
#define MIDI_ENDPOINT_DESC_SIZE						  0x05
